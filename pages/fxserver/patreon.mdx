...
but rather, are applied to all your existing <DefinitionText text={"Keymaster"}/> license keys, allowing you to use the features on all your servers.
